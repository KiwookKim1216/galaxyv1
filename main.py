...
class MainWidget(RelativeLayout):
    ...
    def generate_tiles_coordinates(self):
        ...
        for i in range(len(self.tiles_coordinates)-1, -1, -1):
            debug_val = self.tiles_coordinates[i][1]
    ...
    def update_horizontal_line(self):
        ...
        start_index_y = 0
        end_index_y = self.H_NB_LINES-1

        for i in range(start_index_y, end_index_y+1):
    ...
    def update(self, dt):
        ...
        if not self.check_ship_collision() and not self.state_game_over:
            ...
            Clock.schedule_once(self.play_game_over_voice_sound, 1.25)
            #print("GAME OVER")
